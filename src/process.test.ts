...
describe('getJobConclusions', () => {
  it('should get conclusions', () => {
    expect(getJobConclusions([
      { conclusion: 'cancelled', name: '' },
      { conclusion: null, name: '' },
      { conclusion: 'neutral', name: '' },
      { conclusion: 'failure', name: '' },
      { conclusion: 'success', name: '' },
      { conclusion: 'failure', name: '' },
      { conclusion: 'success', name: '' },
      { conclusion: 'cancelled', name: '' },
      { conclusion: 'skipped', name: '' },
      { conclusion: 'test1', name: '' },
      { conclusion: 'test2', name: '' },
      { conclusion: 'test3', name: '' },
    ])).toEqual([
      'cancelled',
      'neutral',
      'failure',
